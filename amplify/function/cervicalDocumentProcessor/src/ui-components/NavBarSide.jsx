          ...
          >
            ...
            >
              ...
              <Text
                ...
                whiteSpace="pre-wrap"
                children="ICDz-Codes"
                {...getOverrideProps(overrides, "ICD-29767106")}
              ></Text>
            </Flex>
            <Flex
              gap="8px"
              ...
              position="relative"
              padding="0px 0px 0px 0px"
              {...getOverrideProps(overrides, "link38991859")}
            >
              <Flex
                gap="0"
                direction="row"
                ...
                padding="6px 6px 6px 6px"
                backgroundColor="rgba(233,249,252,1)"
                {...getOverrideProps(overrides, "icon38991860")}
              >
                <MyIcon
                  width="18px"
                  height="18px"
                  ...
                  padding="0px 0px 0px 0px"
                  type="content"
                  {...getOverrideProps(overrides, "MyIcon38991861")}
                ></MyIcon>
              </Flex>
              <Text
                fontFamily="Inter"
                ...
                padding="0px 0px 0px 0px"
                whiteSpace="pre-wrap"
                children="CDz-CPTCodes"
                {...getOverrideProps(overrides, "ICD-38991862")}
              ></Text>
            </Flex>
          </Flex>
        </Flex>
