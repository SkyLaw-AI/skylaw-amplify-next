    ...
    >
      ...
      >
        <Flex
          ...
          position="relative"
          padding="0px 0px 0px 0px"
          {...getOverrideProps(overrides, "FeatureRow1")}
        >
          <Flex
            gap="16px"
            direction="column"
          ...
          >
            <Flex
              ...
              {...getOverrideProps(overrides, "IconBox1")}
            >
              <MyIcon
                width="24px"
                height="24px"
          ...
          >
            <Flex
              ...
              padding="8px 8px 8px 8px"
              backgroundColor="rgba(233,249,252,1)"
              {...getOverrideProps(overrides, "IconBox2")}
            >
              <MyIcon
                width="24px"
                height="24px"
        ...
        <Flex
          ...
          position="relative"
          padding="0px 0px 0px 0px"
          {...getOverrideProps(overrides, "FeatureRow2")}
        >
          <Flex
            gap="16px"
            direction="column"
          ...
          >
            <Flex
              ...
              padding="8px 8px 8px 8px"
              backgroundColor="rgba(233,249,252,1)"
              {...getOverrideProps(overrides, "IconBox3")}
            >
              <MyIcon
                width="24px"
                height="24px"
          ...
          <Flex
            ...
            padding="40px 40px 40px 40px"
            backgroundColor="rgba(255,255,255,1)"
            {...getOverrideProps(overrides, "Feature4")}
          >
            <Flex
              gap="0"
              direction="row"
              ...
              padding="8px 8px 8px 8px"
              backgroundColor="rgba(233,249,252,1)"
              {...getOverrideProps(overrides, "IconBox4")}
            >
              <MyIcon
                width="24px"
                height="24px"
                ...
                padding="0px 0px 0px 0px"
                type="checkmark"
                {...getOverrideProps(overrides, "Icon4")}
              ></MyIcon>
            </Flex>
            <Text
              fontFamily="Inter"
